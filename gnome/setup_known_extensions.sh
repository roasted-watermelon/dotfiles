...
set_ext_dconf "hot-sensors" "['__temperature_max__', '__fan_max__']"
set_ext_dconf "icon-style" "0"
set_ext_dconf "include-static-gpu-info" "true"
...
set_ext_dconf "quick-settings-airplane-mode" "false"
set_ext_dconf "quick-settings-dark-mode" "false"
set_ext_dconf "quick-settings-night-light" "false"
